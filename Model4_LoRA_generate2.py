...
# 실행부
# -------------------------------
def main(input_json="model4_lora_prompts.json", out_dir="lora_outputs", lora_dir="model4_lora_weights"):
    ...
    # LoRA adapter 로드
    pipe.unet.load_adapter(lora_dir)
    ...
    for idx, prompt in enumerate(prompts, start=1):
        print(f"\n🎧 Generating LoRA audio for Scene {idx}...")
    ...
    print(f"\n✅ All LoRA audios generated successfully! Saved in '{audio_dir}'")
